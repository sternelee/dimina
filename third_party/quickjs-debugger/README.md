...
POSIX TCP transport shared by Harmony, Android, and iOS integrations.
...
Run the end-to-end transport regression test against a clean checkout of the
pinned QuickJS commit:

```sh
python3 tests/protocol_test.py /path/to/quickjs
```
